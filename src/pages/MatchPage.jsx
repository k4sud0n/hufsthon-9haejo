...
// 사용자 데이터 예시
const users = [
  { name: "홍길동", age: 65, imgSrc: "https://via.placeholder.com/150" }, // placeholder 이미지
  { name: "김영희", age: 62, imgSrc: "https://via.placeholder.com/150" },
  { name: "박철수", age: 70, imgSrc: "https://via.placeholder.com/150" },
  { name: "이소영", age: 67, imgSrc: "https://via.placeholder.com/150" },
];
...
function MatchPage() {
  ...
  return (
    <div className="relative h-full flex flex-col pb-16">
      {/* 회사 이름 좌상단 */}
